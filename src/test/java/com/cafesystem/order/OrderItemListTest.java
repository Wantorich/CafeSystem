...
class OrderItemListTest {
  ...
  void 아메리카노2잔_치즈케이크1개_주문총금액은_15500원이다() {
    OrderItem americano = OrderItem.createOrderItem(
        SingleMenu.createMenu("아메리카노", Price.of(4500), Category.COFFEE), Quantity.of(2), Collections.emptySet());
    OrderItem cheeseCake = OrderItem.createOrderItem(
        SingleMenu.createMenu("치즈케이크", Price.of(6500), Category.DESSERT), Quantity.of(1), Collections.emptySet());
